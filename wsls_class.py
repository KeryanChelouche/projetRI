...
class CrossEntropyLoss(nn._WeightedLoss):
...
class WSLSLoss(nn.Module) :
	def forward(self, input, class_vector, eps=0.1):
		#Traitement WSLS
		return nn.CrossEntropyLoss(input, class_vector)